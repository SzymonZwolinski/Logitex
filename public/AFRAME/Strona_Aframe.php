<!DOCTYPE HTML>
  ...
  <body>
    ...
    <a-scene fog  renderer="precision: low; antialias:false;" movable>
      ...
      <a-entity position="0 1 3.8">
        <a-entity cam1 camera="active: true" look-controls-enabled="false"  keyboard-controls="fpsMode: true" dynamic-body ></a-entity>
      </a-entity>
