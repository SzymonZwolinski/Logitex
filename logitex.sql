...
CREATE TABLE `cars` (
  ...
  `dopuszczalna_masa` decimal(8,2) NOT NULL,
...
INSERT INTO `cars` VALUES (1,'pugot','306',1700.00,1),(3,'fiat','bravo',123123.00,1);
...
CREATE TABLE `final_orders` (
  ...
  `id_zamowienia` bigint(20) unsigned NOT NULL,
  `waga` int(11) NOT NULL,
  `ilosc_ladunku` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `final_orders_id_naczepy_foreign` (`id_naczepy`),
  KEY `final_orders_id_pojazdu_foreign` (`id_pojazdu`),
  KEY `final_orders_id_zamowienia_foreign` (`id_zamowienia`),
  CONSTRAINT `final_orders_id_naczepy_foreign` FOREIGN KEY (`id_naczepy`) REFERENCES `trailers` (`id`),
  CONSTRAINT `final_orders_id_pojazdu_foreign` FOREIGN KEY (`id_pojazdu`) REFERENCES `cars` (`id`),
  CONSTRAINT `final_orders_id_zamowienia_foreign` FOREIGN KEY (`id_zamowienia`) REFERENCES `orders` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `trailers` VALUES (1,123,123,2,1231,123,123,1);
...
-- Dump completed on 2022-05-30 20:30:58
